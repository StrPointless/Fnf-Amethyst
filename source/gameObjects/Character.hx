...
class Character extends FNFSprite
{
	...
	//public var animationsArray:Array<AnimArray> = []; //Common Shadow W
	...
	public function setCharacter(x:Float, y:Float, character:String):Character
	{
		...
		switch (curCharacter)
		{
			...
			case 'dad':
				...
				playAnim('idle');
			case 'sapph':
				// SAPPH ANIMATION LOADING CODE
				tex = Paths.getSparrowAtlas('characters/SAPPHIRE_assets');
				frames = tex;
